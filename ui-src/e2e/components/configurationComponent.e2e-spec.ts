...
describe("configuration component", () => {
  ...
  it("should check that all text box names are correct", () => {
    ...
    it("should check for file", () => {
      ...
      expect(configPO.testSuite.getAttribute("value")).toEqual("suiteFileName.xml");
      ...
      expect(configPO.testCaseDir.getAttribute("value")).toEqual("./definitions/testCases");
      expect(configPO.testSuiteDir.getAttribute("value")).toEqual("./definitions/testSuites");
