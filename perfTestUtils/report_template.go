...
func reportContentTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "report/content.tmpl", size: 6292, mode: os.FileMode(420), modTime: time.Unix(1481534084, 0)}
